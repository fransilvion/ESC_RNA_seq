...
model_weights <- ifelse(train_data$Inducer == 0,
...
# Build weighted model (no regularizer)
...
model_list <- list(original = weighted_logistic_fit,
                   lasso = weighted_logistic_fit_lasso,

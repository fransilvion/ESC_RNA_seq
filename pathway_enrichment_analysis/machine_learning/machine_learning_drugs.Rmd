...
ACCURACY: 0.9067 SENSITIVITY: 0.364 SPECIFICITY: 0.9353 PRECISION: 0.2296 F1: 0.2818
...
summary_ops_tr = tf.summary.merge([acc_tr_sum,loss_train_sum])
summary_ops_val = tf.summary.merge([acc_val_sum,loss_val_sum])
...
# with statement ensures updates are done before backpropagation
